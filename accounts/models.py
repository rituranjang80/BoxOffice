...
class Movie(models.Model):
    ...
    userid=models.DecimalField(max_digits=3, decimal_places=1)
...
class Shows(models.Model):
    ...
    movieURL=models.CharField(max_length=500, default="")
    movieDescrption=models.CharField(max_length=500, default="")
...
class Bookings(models.Model):
    Bookings=models.AutoField(primary_key=True)
